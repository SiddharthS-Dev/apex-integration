                ...
                <div role="menu" className="absolute right-0 top-full w-56 pt-2">
                  <div className="glass-strong rounded-xl p-3 shadow-lift">
                    ...
                    <div className="mt-3 space-y-1">
                      {user?.role === 'admin' && (
                        <Link to="/admin" role="menuitem" className="block rounded-lg px-3 py-2 text-xs text-chalk transition hover:bg-white/5">
                          Admin console
                        </Link>
                      )}
                      <Link to="/offline" role="menuitem" className="block rounded-lg px-3 py-2 text-xs text-chalk transition hover:bg-white/5">
                        Offline library
                      </Link>
                    </div>
                    <button
          ...
          >
            ...
            <div className="flex flex-1 flex-col justify-center gap-1 px-8 pb-24">
              ...
              <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ delay: 0.3 }} className="mt-8 space-y-3">
                ...
                <Link to="/offline" className="btn-ghost w-full" onClick={() => setOpen(false)}>
                  Offline library
                </Link>
                {user?.role === 'admin' && (
                  <Link to="/admin" className="btn-ghost w-full" onClick={() => setOpen(false)}>
                    Admin console
                  </Link>
                )}
