      ...
      window.google.accounts.id.initialize({
        ...
        callback: async ({ credential }) => {
          try {
            ...
            // the API backend verifies `credential` server-side; the demo backend reads the profile
            onSession(await api.loginWithGoogle({ credential, email: p.email, name: p.name, picture: p.picture }))
          } catch (e) {
