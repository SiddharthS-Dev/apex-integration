...
import AuthShell, { ErrorNote, Field, InfoNote, Submit } from '../components/AuthShell'
...
function ApexHandoff() {
  ...
  return (
    <div className="flex min-h-screen flex-col items-center justify-center gap-4 bg-ink text-sm text-muted">
      <div className="h-10 w-10 animate-spinSlow rounded-full border-2 border-white/10 border-t-cyan-glow" />
      Taking you to the Apex sign-in…
    </div>
  )
}
